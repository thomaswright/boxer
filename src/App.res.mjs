...
import * as ThemeToggle from "./ThemeToggle.res.mjs";
...
function App(props) {
  ...
  let setViewportCenter = match$1[1];
  let viewportCenter = match$1[0];
  ...
  let match$2 = UseLocalStorageJs(StorageKeys.canvases, []);
  ...
  let setBoardHistoryByCanvas = match$4[1];
  let boardHistoryByCanvas = match$4[0];
  ...
  let match$5 = UseLocalStorageJs(StorageKeys.savedBrushes, defaultBrushEntries);
  let setSavedBrushes = match$5[1];
  let savedBrushes = match$5[0];
  let match$6 = UseLocalStorageJs(StorageKeys.savedTileMasks, defaultTileMaskEntries);
  ...
  let match$9 = UseLocalStorageJs(StorageKeys.selectedBrushId, undefined);
  let setSelectedBrushId = match$9[1];
  let selectedBrushId = match$9[0];
  let match$10 = UseLocalStorageJs(StorageKeys.selectedTileMaskId, undefined);
  let setSelectedTileMaskId = match$10[1];
  let selectedTileMaskId = match$10[0];
  let match$11 = UseLocalStorageJs(StorageKeys.selectedCanvasId, undefined);
  let setSelectedCanvasId = match$11[1];
  let selectedCanvasId = match$11[0];
  let match$12 = UseLocalStorageJs(StorageKeys.myColor, Initials.myColor);
  let setMyColor = match$12[1];
  let myColor = match$12[0];
  let match$13 = UseLocalStorageJs(StorageKeys.brushMode, "Color");
  let setBrushMode = match$13[1];
  let brushMode = match$13[0];
  let match$14 = UseLocalStorageJs(StorageKeys.brushOverlayMode, "overlay");
  let overlayMode = match$14[0];
  let match$15 = UseLocalStorageJs(StorageKeys.gridMode, "none");
  let gridMode = match$15[0];
  let match$16 = UseLocalStorageJs(StorageKeys.silhouette, false);
  let isSilhouette = match$16[0];
  let match$17 = React.useState(() => false);
  let setCursorOverlayOff = match$17[1];
  let match$18 = React.useState(() => "16");
            ...
            JsxRuntime.jsxs("div", {
              children: [
                ...
                JsxRuntime.jsx(ExportControl.make, {
                  ...
                  setExportScaleInput: match$18[1],
                  includeExportBackground: includeExportBackground,
                  setIncludeExportBackground: match$19[1],
